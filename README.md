...
# Alien Attack! - CPROG Programmeringsprojekt
**Gruppnummer:** 02  
**Gruppmedlemmar:** Alexander Herder

Detta projekt är en 2D-rymdshooter byggd med C++ och SDL3. Projektet består av en generell spelmotor ("GameEngine") och en specifik spelimplementation ("Alien Attack!").
...
### Bygga projektet
Öppna en terminal i projektets rotkatalog (där `Makefile` ligger) och kör kommandot:
...
Efter att kompileringen är klar, starta spelet genom att köra följande kommando i terminalen:
